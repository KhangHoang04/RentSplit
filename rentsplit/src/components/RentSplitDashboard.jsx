  ...
  useEffect(() => {
    const fetchUserAndHouseholds = async () => {
      try {
        ...
        setHouseholds(householdData.households); // expect this to be an array of households
      ...
      try {
        ...
        if (res.ok) {
          ...
          const chartData = Object.entries(grouped).map(([name, value]) => ({
            name,
            value,
            icon: getTransactionIcon(name), // same icon logic you already use
          }));
              ...
              <CardHeader className="pb-2 border-b border-slate-100 bg-white">
                <CardTitle className="text-xl text-slate-800 flex items-center justify-between">
                  ...
                  <div className="flex gap-1">
                    ...
                    <Button
                      variant={
                        activeFilter === "overdue" ? "default" : "outline"
                      }
                      size="sm"
                          ...
                          >
                            <div className="flex items-center justify-between mb-3">
                              <div className="flex items-center gap-3 w-full min-w-0">
                                ...
                                <span className="font-semibold text-slate-800 text-sm break-words whitespace-normal w-full overflow-hidden">
                            ...
                            {member.amountOwedToCurrentUser > 0 && (
                              <div className="text-sm text-slate-600 mb-3 p-2 bg-amber-50 border border-amber-100 rounded">
                                ...
                                <span className="font-bold text-amber-600">
                                  {formatCurrency(
                                    member.amountOwedToCurrentUser
                                  )}
                                </span>
                              </div>
                            )}
            ...
            <Card className="border-slate-200 shadow-md overflow-hidden">
              ...
              <CardContent className="pt-6 bg-gradient-to-br from-white to-slate-50">
                <div className="grid grid-cols-2 gap-3">
                  <Button
                    variant="outline"
                    className="flex flex-col h-28 items-center justify-center ..."
                    onClick={() => setShowHouseholdModal(true)}
                  >
                ...
                {households.length > 0 ? (
                  households.map((household) => (
                    <Button
                      ...
                      className="w-full text-left justify-start border border-slate-200 shadow-sm 
                                  bg-transparent 
                                  hover:bg-gradient-to-r hover:from-blue-300 hover:to-emerald-300 
                                  active:bg-gradient-to-r active:from-blue-500 active:to-emerald-500 
