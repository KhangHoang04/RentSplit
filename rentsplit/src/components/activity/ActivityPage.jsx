...
export default function ActivityPage({ user }) {
  ...
  // Step 2: Fetch expenses after user is loaded
  useEffect(() => {
  ...
  const filteredExpenses = expenses.filter((exp) => {
    const categoryMatch =
      !filters.category || exp.expense_id?.category === filters.category;

    const expDate = new Date(exp.date);
    const startDateMatch =
      !filters.startDate || expDate >= new Date(filters.startDate);
    const endDateMatch =
      !filters.endDate || expDate <= new Date(filters.endDate);
        ...
        <div className="max-w-6xl mx-auto py-8 px-6">
          ...
          <div className="mb-8">
            ...
            <p className="mt-2 text-gray-400">
              Track all household expenses in one place
            </p>
          </div>
              ...
              {loading ? (
                ...
                <div className="flex flex-col items-center justify-center py-16 px-4">
                  ...
                  <p className="text-gray-500 text-center mb-8">
                    Try adjusting your filters, or add a new expense to get
                    started.
                  </p>
                  <Button
                        ...
                        {filteredExpenses.map((expense) => (
                          ...
                          >
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              <div className="flex items-center">
                                <div className="flex-shrink-0 h-8 w-8 flex items-center justify-center rounded-full bg-blue-100 text-blue-600">
                                  {expense.expense_id.category === "Rent" && (
                                    <svg
                                      xmlns="http://www.w3.org/2000/svg"
                                      width="16"
                                      height="16"
                                  ...
                                  {expense.expense_id.category === "Water" && (
                                    <svg
                                      xmlns="http://www.w3.org/2000/svg"
                                      width="16"
                                      height="16"
                                  ...
                                  {(expense.expense_id.category === "Gas" ||
                                    expense.category === "Heat") && (
                                    <svg
                                      xmlns="http://www.w3.org/2000/svg"
                                      width="16"
                                      height="16"
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                              {expense.user_id?.username || "Unknown"}
                            </td>
                            <td className="px-6 py-4 whitespace-nowrap">
                              <span
