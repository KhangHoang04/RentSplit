  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      <header className="mb-8">
        <h1 className="text-3xl font-bold mb-2">RentSplit Dashboard</h1>
      ...
      {pendingPayments > 0 && (
        <Alert className="mb-6 border-yellow-500 bg-yellow-50">
          ...
          <AlertTitle className="text-yellow-800">Payment Reminder</AlertTitle>
                    ...
                    <div key={txn.id} className="p-3 border rounded-lg flex justify-between items-center">
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-gray-500">Due: {txn.dueDate}</div>
                        </div>
                      </div>
